<?php
class Costos_inscripcion extends Controller
{
    ...
    {
        $data['title'] = 'Costos de inscripción';
        $data['script'] = 'costos_inscripcion.js';
        $this->views->getView('costos_inscripcion', 'index', $data);
    }
