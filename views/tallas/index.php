            ...
            <div class="card bg-secondary text-white">
                <div class="card-header mb-2 text-center ">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 py-3 contenedor-usuarios">
                        ...
                        <div class="text-end">
                            <a href="<?php echo BASE_URL . 'tallas/inactivos'; ?>"><i class="fas fa-trash text-danger me-2"></i>Carreras Inactivas</a>
                        </div>
                    </div>
                    <!-- titulo -->
                    <hr class="mb-3 ">
                    <div class="contenedor-titulo">
                        <h3 class="#">
                            <i class="fas fa-graduation-cap me-2"></i>Listado de tallas
                        </h3>
                    </div>
                    <hr class="mb-3">
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre del estudiante">
                                                </div>
                                                <span id="errorNombre" class="text-danger"></span>
                                            </div>

                                            <!-- TODO: Talla de Polera -->
                                            <div class="col-lg-6 col-sm-6">
                                                <label for="talla" class="form-label mb-2">Talla de Polera</label>
                                                <select class="form-select" id="talla" name="talla">
                                                    <option value="">Seleccione una talla de polera</option>
                                            ...
                                            <div class="col-lg-12 col-sm-12 mb-3">
                                                <label for="descripcion" class="form-label text-white mb-2">Mensaje (opcional)</label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-comment"></i></span>
                                                    <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Escriba un descripcion opcional"></textarea>
                                                </div>
                                            </div>
                                        </div>
