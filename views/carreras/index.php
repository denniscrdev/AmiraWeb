                                    ...
                                    <form class="p-4" id="formulario" autocomplete="off">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"><i class="bi bi-person-fill"></i></span>
                                                    <input type="text" class="form-control" id="delegado" name="delegado" placeholder="Delegado">
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"><i class="bi bi-person-fill"></i></span>
                                                    <input type="number" class="form-control" id="contacto" name="contacto" placeholder="Contacto">
                                                </div>
