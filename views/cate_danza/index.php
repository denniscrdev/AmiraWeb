            ...
            <div class="card bg-secondary text-white">
                <div class="card-header mb-2 text-center ">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 py-3 contenedor-usuarios">
                        ...
                        <div class="text-end">
                            <a href="<?php echo BASE_URL . 'cate_danza/inactivos'; ?>"><i class="fas fa-trash text-danger me-2"></i>Categorias Inactivas</a>
                        </div>
                    </div>
                    <!-- titulo -->
                    <hr class="mb-3 ">
                    <div class="contenedor-titulo">
                        <h3 class="#">
                            <i class="fas fa-graduation-cap me-2"></i>Categorias de Danza
                        </h3>
                    </div>
                    <hr class="mb-3">
                </div>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade active show" id="nav_listar" role="tabpanel" aria-labelledby="nav_listar-tab">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-dark text-center" id="tblCate_danza" style="width: 100%;">
                                        <thead class="thead-light">
                                            <tr>
                                                <th class="text-center">Nombre</th>
                                                <th class="text-center">Descripción</th>
                                                <th class="text-center">Max_integrantes</th>
