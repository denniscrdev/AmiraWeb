...
<div class="jd-slider">
    <div class="slide-inner">
        <ul class="slide-area">
            <li>
                <img src="<?php echo BASE_URL; ?>assets/portal/img/slide/1/back_default.jpg" class="img-fluid">
                <div class="slideOpt opt1">
                    <img src="<?php echo BASE_URL; ?>assets/portal/img/slide/1/calzado.png" style="top:15%; right:10%; width:45%">
            ...
            <li>
                <img src="<?php echo BASE_URL; ?>assets/portal/img/slide/2//fondo2.jpg" class="img-fluid">
                <div class="slideOpt opt2">
                    <img src="<?php echo BASE_URL; ?>assets/portal/img/slide/2//iphone.png" style="bottom:0%; left:15%; width:28%">
            ...
            <li>
                <img src="<?php echo BASE_URL; ?>assets/portal/img/slide/3/fondo3.jpg" class="img-fluid">
            </li>
        </ul>
    </div>
