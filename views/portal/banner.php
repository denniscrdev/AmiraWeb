<div class="container-fluid banner" style="position:relative; background: url('<?php echo BASE_URL; ?>assets/portal/img/banner/1/default.jpg');background-size:cover;background-position: center; background-repeat: no-repeat;">
